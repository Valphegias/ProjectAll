...
/// Send to all player 
bool ChatHandler::HandleSouhaiteBienvenueCommand(char* /*args*/)
{
    PSendSysMessage(LANG_SOUHAITE_BIENVENUE);
    return true;
}

bool ChatHandler::HandlePointsCommand(char* /*args*/)
{
    PSendSysMessage(LANG_POINTS, m_session->GetPlayer()->GetPoints());
    return true;
}